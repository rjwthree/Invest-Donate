...
Another important aspect of reality is inflation. Inflation could be modeled as simply reducing the asset's growth rate, but inflation of a basket of goods that are relevant to your own life may not bear a close relation to how the costs of work being done by charities - potentially on another continent - change over time.
